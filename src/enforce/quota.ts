...
export function applyQuotasOrThrow(
	...
	if (s.calls_total + 1 > maxTotal)
		throw new Error("Quota exceeded: max_calls_per_request");
	if (curTool + 1 > maxPerTool)
		throw new Error("Quota exceeded: max_calls_per_tool");
