...
const schema = z.object({
	...
	POLICY_PATH: z
		.string()
		.default(path.join(projectRoot, "tool_risk_tier.yaml")),
	ALLOWED_SIGNERS_DIR: z
		.string()
		.default(path.join(projectRoot, "allowed_signers")),
	ADMIN_IDENTITIES: z
		.string()
		.default("")
		.transform((value) =>
	...
	RATE_LIMIT_CHALLENGE_PER_MIN: z.coerce
		.number()
		.int()
		.min(1)
		.max(60)
